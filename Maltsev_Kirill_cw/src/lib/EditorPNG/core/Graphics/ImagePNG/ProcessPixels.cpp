...
{   
    ...
    Color color;
    color.r = row_pointers_[x][y * pixel_size_ + R_IDX];
    color.g = row_pointers_[x][y * pixel_size_ + G_IDX];
    color.b = row_pointers_[x][y * pixel_size_ + B_IDX];
    color.a = row_pointers_[x][y * pixel_size_ + A_IDX];
    return color;
}
